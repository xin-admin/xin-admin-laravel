...
-- ----------------------------
INSERT INTO `admin_rule` VALUES (2, 0, '0', 998, '示例组件', '/data', 'GoldOutlined', 'data', 'menu.components', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:57:24');
...
INSERT INTO `admin_rule` VALUES (7, 92, '1', 0, '管理员列表', '/admin/list', '', 'admin.list', 'menu.admin.list', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `admin_rule` VALUES (8, 92, '1', 1, '管理员分组', '/admin/group', '', 'admin.group', 'menu.admin.group', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `admin_rule` VALUES (9, 92, '1', 2, '权限菜单管理', '/admin/rule', '', 'admin.rule', 'menu.admin.rule', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
...
INSERT INTO `admin_rule` VALUES (88, 0, '0', 999, '仪表盘', '/dashboard', 'PieChartOutlined', 'dashboard', 'menu.dashboard', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:57:07');
...
INSERT INTO `admin_rule` VALUES (118, 0, '0', 100, '用户设置', '/admin/setting', '', 'admin.setting', NULL, 1, 0, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
...
CREATE TABLE `monitor`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 53 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '数据监控表' ROW_FORMAT = DYNAMIC;
...
CREATE TABLE `sys_rule`  (
  ...
  UNIQUE INDEX `key`(`key`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 123 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '权限规则表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sys_rule
-- ----------------------------
INSERT INTO `sys_rule` VALUES (2, 0, '0', 998, '示例组件', '/data', 'GoldOutlined', 'data', 'menu.components', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:57:24');
INSERT INTO `sys_rule` VALUES (3, 2, '1', 0, '定义列表', '/data/descriptions', '', 'data.descriptions', 'menu.components.descriptions', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (7, 92, '1', 0, '管理员列表', '/admin/list', '', 'admin.list', 'menu.admin.list', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (8, 92, '1', 1, '管理员分组', '/admin/group', '', 'admin.group', 'menu.admin.group', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (9, 92, '1', 2, '权限菜单管理', '/admin/rule', '', 'admin.rule', 'menu.admin.rule', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (10, 0, '0', 995, '系统管理', '/system', 'ClusterOutlined', 'system', 'menu.system', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:58:19');
INSERT INTO `sys_rule` VALUES (11, 10, '1', 3, '字典管理', '/system/dict', '', 'system.dict', 'menu.system.dict', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (12, 11, '2', 0, '字典新建', NULL, '', 'system.dict.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (13, 11, '2', 0, '字典删除', NULL, '', 'system.dict.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (14, 11, '2', 0, '字典编辑', NULL, '', 'system.dict.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (15, 11, '2', 0, '字典查看', NULL, '', 'system.dict.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (16, 7, '2', 0, '查看管理员列表', NULL, '', 'admin.list.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (17, 7, '2', 0, '新增管理员', NULL, '', 'admin.list.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (18, 7, '2', 0, '编辑管理员', NULL, '', 'admin.list.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (19, 7, '2', 0, '删除管理员', NULL, '', 'admin.list.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (20, 8, '2', 0, '管理员分组查看', NULL, '', 'admin.group.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (21, 8, '2', 0, '管理员分组新增', NULL, '', 'admin.group.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (22, 8, '2', 0, '管理员分组编辑', NULL, '', 'admin.group.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (23, 8, '2', 0, '管理员分组删除', NULL, '', 'admin.group.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (24, 8, '2', 0, '分组权限查看', NULL, '', 'admin.group.rule', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (25, 8, '2', 0, '管理员权限修改', NULL, '', 'admin.group.ruleEdit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (26, 9, '2', 0, '权限管理查看', NULL, '', 'admin.rule.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (27, 9, '2', 0, '权限管理新增', NULL, '', 'admin.rule.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (28, 9, '2', 0, '权限管理编辑', NULL, '', 'admin.rule.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (29, 9, '2', 0, '权限管理删除', NULL, '', 'admin.rule.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (30, 11, '2', 0, '字典配置', NULL, '', 'system.dict.item.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (31, 11, '2', 0, '字典配置新增', NULL, '', 'system.dict.item.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (32, 11, '2', 0, '字典配置编辑', NULL, '', 'system.dict.item.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (33, 11, '2', 0, '字典配置删除', NULL, '', 'system.dict.item.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (35, 2, '1', 0, '高级列表', '/data/list', '', 'data.list', 'menu.components.list', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (36, 2, '1', 0, '单选卡片', '/data/checkcard', '', 'data.checkcard', 'menu.components.checkcard', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (39, 0, '0', 997, '会员管理', '/user', 'UserOutlined', 'user', 'menu.user', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:57:34');
INSERT INTO `sys_rule` VALUES (40, 39, '1', 0, '会员列表', '/user/list', '', 'user.list', 'menu.user.list', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (43, 0, '0', 994, '在线开发', '/online', 'CodeOutlined', 'online', 'menu.online', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:58:46');
INSERT INTO `sys_rule` VALUES (44, 43, '1', 0, '表格设计', '/online/table', '', 'online.table', 'menu.online.table', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (48, 0, '0', 99, 'Xin Admin', 'https://xinadmin.cn/', 'ItalicOutlined', 'xinadmin', 'menu.xinadmin', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:59:16');
INSERT INTO `sys_rule` VALUES (49, 10, '1', 5, '系统信息', '/system/info', '', 'system.info', 'menu.system.info', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (50, 10, '1', 4, '系统设置', '/system/setting', '', 'system.setting', 'menu.system.setting', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (51, 50, '2', 0, '设置分组查看', NULL, '', 'system.setting.querySettingGroup', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (52, 50, '2', 1, '设置分组新增', NULL, '', 'system.setting.addGroup', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (53, 50, '2', 3, '查询设置父 ID', NULL, '', 'system.setting.querySettingPid', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (54, 44, '2', 0, '表格设计查询', NULL, '', 'online.table.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (55, 44, '2', 1, '表格设计编辑', NULL, '', 'online.table.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (56, 44, '2', 2, '表格设计删除', NULL, '', 'online.table.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (57, 44, '2', 3, '表格设计', NULL, '', 'online.tableDevise', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (58, 44, '2', 4, 'CRUD 保存', NULL, '', 'online.table.saveData', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (59, 44, '2', 5, '获取 CRUD 数据', NULL, '', 'online.table.getData', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (60, 44, '2', 6, 'CRUD 保存并生成', NULL, '', 'online.table.crud', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (61, 50, '2', 3, '获取设置列表', NULL, '', 'system.setting.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (62, 50, '2', 4, '新增设置', NULL, '', 'system.setting.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (63, 50, '2', 5, '编辑设置', NULL, '', 'system.setting.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (64, 50, '2', 6, '删除设置', NULL, '', 'system.setting.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (69, 39, '1', 2, '会员分组', '/user/group', '', 'user.group', 'menu.user.group', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (70, 39, '1', 2, '权限管理', '/user/rule', '', 'user.rule', 'menu.user.rule', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (71, 40, '2', 1, '会员列表查询', NULL, '', 'user.list.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (72, 40, '2', 2, '会员列表编辑', NULL, '', 'user.list.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (73, 40, '2', 3, '会员列表新增', NULL, '', 'user.list.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (74, 40, '2', 4, '会员列表删除', NULL, '', 'user.list.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (75, 69, '2', 1, '会员分组查询', NULL, '', 'user.group.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (76, 69, '2', 2, '会员分组新增', NULL, '', 'user.group.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (77, 69, '2', 3, '会员分组编辑', NULL, '', 'user.group.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (78, 69, '2', 4, '会员分组删除', NULL, '', 'user.group.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (79, 69, '2', 5, '分组权限查看', NULL, '', 'user.group.rule', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (80, 69, '2', 6, '分组权限修改', NULL, '', 'user.group.ruleEdit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (81, 39, '1', 4, '会员余额记录', '/user/moneyLog', '', 'user.moneyLog', 'menu.user.moneyLog', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (82, 81, '2', 0, '会员余额记录查询', NULL, '', 'user.moneyLog.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (83, 81, '2', 2, '修改用户余额', NULL, '', 'user.moneyLog.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (84, 44, '2', 0, '表格设计新增', NULL, '', 'online.table.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (85, 81, '2', 3, '会员余额记录删除', NULL, '', 'user.moneyLog.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (86, 2, '1', 0, '表单示例', '/data/form', '', 'data.form', 'menu.components.form', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (87, 7, '2', 1, '修改管理员密码', NULL, '', 'admin.list.updatePassword', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (88, 0, '0', 999, '仪表盘', '/dashboard', 'PieChartOutlined', 'dashboard', 'menu.dashboard', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:57:07');
INSERT INTO `sys_rule` VALUES (89, 88, '1', 10, '分析页', '/dashboard/analysis', '', 'dashboard.analysis', 'menu.dashboard.analysis', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (90, 88, '1', 1, '监控页', '/dashboard/monitor', '', 'dashboard.monitor', 'menu.dashboard.monitor', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (91, 88, '1', 2, '工作台', '/dashboard/workplace', '', 'dashboard.workplace', 'menu.dashboard.workplace', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (92, 0, '0', 996, '管理员', '/admin', 'BankOutlined', 'admin', 'menu.admin', 1, 1, '2024-12-13 01:19:11', '2024-12-13 05:58:10');
INSERT INTO `sys_rule` VALUES (93, 2, '1', 5, '高级表格', '/data/table', '', 'data.table', 'menu.components.table', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (94, 2, '1', 6, '图标选择', '/data/icon', '', 'data.icon', 'menu.components.iconForm', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (102, 10, '1', 4, '文件管理', '/system/file', '', 'system.file', 'menu.File', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (103, 102, '2', 0, '文件分组列表', NULL, '', 'file.group.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (104, 102, '2', 1, '新增文件分组', NULL, '', 'file.group.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (105, 102, '2', 2, '编辑文件分组', NULL, '', 'file.group.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (106, 102, '2', 3, '删除文件分组', NULL, '', 'file.group.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (107, 102, '2', 4, '获取文件列表', NULL, '', 'file.file.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (108, 102, '2', 5, '删除文件', NULL, '', 'file.file.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (109, 102, '2', 6, '上传图片文件', NULL, '', 'file.upload.image', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (110, 102, '2', 7, '上传视频文件', NULL, '', 'file.upload.video', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (111, 102, '2', 8, '上传压缩文件', NULL, '', 'file.upload.zip', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (112, 102, '2', 9, '上传音频文件', NULL, '', 'file.upload.mp3', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (113, 102, '2', 10, '上传其它文件', NULL, '', 'file.upload.annex', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (114, 70, '2', 99, '权限列表', NULL, '', 'user.rule.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (115, 70, '2', 88, '会员权限新增', NULL, '', 'user.rule.add', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (116, 70, '2', 60, '会员权限删除', NULL, '', 'user.rule.delete', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (117, 70, '2', 0, '会员权限编辑', NULL, '', 'user.rule.edit', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (118, 0, '0', 100, '用户设置', '/admin/setting', '', 'admin.setting', NULL, 1, 0, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (119, 10, '1', 5, '系统监控', '/system/monitor', '', 'system.monitor', 'menu.system.monitor', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (120, 119, '2', 5, '监控列表', NULL, '', 'system.monitor.list', NULL, 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (121, 7, '2', 0, '重置密码', '', '', 'admin.list.resetPassword', '', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
INSERT INTO `sys_rule` VALUES (122, 40, '2', 0, '用户充值', '', '', 'user.list.recharge', '', 1, 1, '2024-12-13 01:19:11', '2024-12-13 01:19:11');
...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES (1, 'admin', 'Admin', 41, '0', 'admin@xinadmin.cn', '1888888888', '1', 0, 0, '$2y$10$6u8Yqd90Qpc4P/xJ3F5J1.5.NiCB2CZ8JgC9MkEzCcGCQ0esDExCC', NULL, NULL, NULL, '2024-10-10 06:11:59', NULL);
INSERT INTO `sys_user` VALUES (2, 'test', 'text', 40, '0', '2@qq.cin', '15899999999', '1', 0, 0, '$2y$10$c2uQdzrxDBrYRGo8NNhAwuKx.pXT1AtdzF2PKux9F./zlL2vSguym', NULL, NULL, '2024-09-27 08:18:39', '2024-09-28 11:54:29', NULL);
...
-- Records of token
-- ----------------------------
INSERT INTO `token` VALUES ('470689728d08c2e02605851f1f9e9f07aebfe932', 'admin-refresh', 1, 1736561846, 1733969846);
INSERT INTO `token` VALUES ('d74202400d7861320dc601976ec0a8bf01b2f57a', 'admin-refresh', 1, 1736581707, 1733989707);
INSERT INTO `token` VALUES ('19420f8696b4c73934cd64cffcd120256e42c29c', 'admin-refresh', 1, 1736581981, 1733989981);
INSERT INTO `token` VALUES ('c674465d0bff6d4b6a9478f0bac6baedeb331501', 'admin-refresh', 1, 1736582047, 1733990047);
INSERT INTO `token` VALUES ('1a65fa17ae67e5a32560d4ef22ea526b90a0fcff', 'admin', 1, 1734073273, 1734072673);
INSERT INTO `token` VALUES ('21d87c95504c843cda5885731b7001a78bd86db5', 'admin-refresh', 1, 1736664826, 1734072826);
INSERT INTO `token` VALUES ('1d89f1dbe0da68888b1b8e2d7045b11a08491977', 'admin', 1, 1734074308, 1734073708);
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, '15999999999', 'user', 'liu@xinadmin.cn', '$2y$10$uT69rqj3E65JG4K.eYpFduGtw.zfJUNVvatouqlgmx2BDdlexkaeu', '小刘同学', 33, '0', NULL, 1, 57000, 0, '', '1', NULL, '2024-11-19 05:56:08');
...
INSERT INTO `user_money_log` VALUES (7, 1, '1', 100, '1', '2024-11-19 02:12:26');
INSERT INTO `user_money_log` VALUES (8, 1, '1', 12300, '123', '2024-11-19 03:10:41');
INSERT INTO `user_money_log` VALUES (9, 1, '1', 100, '1', '2024-11-19 03:12:34');
INSERT INTO `user_money_log` VALUES (10, 1, '1', 12300, '12', '2024-11-19 03:24:15');
INSERT INTO `user_money_log` VALUES (11, 1, '1', 12300, '1', '2024-11-19 05:56:08');
...
-- ----------------------------
INSERT INTO `user_rule` VALUES (1, 0, '0', 99, '首页', '/', 'HomeOutlined', 'index', 'menu.index', 1, 1, NULL, '2024-12-12 07:40:59');
INSERT INTO `user_rule` VALUES (9, 0, '0', 0, '代码仓库', '/git', 'StarOutlined', 'git', 'menu.git', 1, 1, NULL, '2024-12-05 01:18:01');
INSERT INTO `user_rule` VALUES (10, 9, '1', 0, 'Github', 'https://github.com/Xineny-liu/xinadmin', NULL, 'xinadmin', 'menu.github', 1, 1, NULL, NULL);
INSERT INTO `user_rule` VALUES (11, 9, '1', 1, 'Gitee', 'https://gitee.com/xineny/xin-admin', NULL, 'gitee', 'menu.gitee', 1, 1, NULL, NULL);
INSERT INTO `user_rule` VALUES (12, 0, '0', 0, '官方文档', 'https://xinadmin.cn', 'FileSearchOutlined', 'ttps:..xinadmin.cn', 'menu.xinadmin', 1, 1, NULL, '2024-12-05 01:18:01');
INSERT INTO `user_rule` VALUES (13, 0, '0', 98, '会员中心', '/user', 'UserOutlined', 'user', 'menu.users', 1, 1, NULL, '2024-12-05 01:18:02');
INSERT INTO `user_rule` VALUES (17, 13, '1', 99, '个人中心', '/user', NULL, 'user', 'menu.user', 1, 1, NULL, NULL);
INSERT INTO `user_rule` VALUES (18, 13, '1', 98, '账户设置', '/user/userSetting', NULL, 'user.userSetting', 'menu.userSetting', 1, 1, NULL, NULL);
INSERT INTO `user_rule` VALUES (19, 13, '1', 97, '修改密码', '/user/setPassword', NULL, 'user.setPassword', 'menu.setPassword', 1, 1, NULL, NULL);
INSERT INTO `user_rule` VALUES (20, 13, '1', 0, '资产记录', '/user/log', NULL, 'user.log', 'menu.log', 1, 1, NULL, NULL);
INSERT INTO `user_rule` VALUES (21, 20, '1', 0, '余额记录', '/user/log/moneyLog', NULL, 'user.log.moneyLog', 'menu.log.moneyLog', 1, 1, NULL, NULL);
