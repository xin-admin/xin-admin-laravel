...
import ColumnsForm from '@/pages/backend/Online/TableDevise/components/ColumnsForm';
import TableSettingFrom from '@/pages/backend/Online/TableDevise/components/TableSettingFrom';
import CrudForm from '@/pages/backend/Online/TableDevise/components/CrudForm';
