...
import { defaultCRUDConfig } from '@/pages/backend/Online/TableDevise/components/defaultData';
  ...
  const crudColumns: ProFormColumnsType<OnlineType.CrudConfig>[] = [
    ...
    },
    {
      ...
      fieldProps: {
        ...
        addonBefore: 'web/src/pages/backend/',
      },
      tooltip: '将生成（web/src/pages/backend/ + 输入路径 + 文件夹（文件名） + index.tsx）文件，文件目录即为URL访问目录',
    },
    {
      title: '权限标识',
      dataIndex: 'ruleName',
