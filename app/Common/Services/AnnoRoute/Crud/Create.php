...
namespace App\Common\Services\AnnoRoute\Crud;

use App\Common\Services\AnnoRoute\BaseAttribute;
use App\Common\Services\AnnoRoute\CrudInterface;
use Attribute;
use Illuminate\Http\Request;

#[Attribute(Attribute::TARGET_CLASS)]
class Create extends BaseAttribute implements CrudInterface
{
    /** @var string 路由地址 */
    public string $route = '';
